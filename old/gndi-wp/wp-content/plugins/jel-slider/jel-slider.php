 ...
 */
function jel_slider_scripts(){
	$css_url = plugins_url('css/jel-slider.css', __FILE__);
	wp_enqueue_style('jel-slider-style', $css_url);
	...
	//add out custtom JS to activate
	$custom_url = plugins_url('js/jel-slider.js', __FILE__);
	wp_enqueue_script('jel-slider-js', $custom_url, array ('jquery', 'responsiveslides'), '0.1', true);
}
add_action('wp_enqueue_scripts', 'jel_slider_scripts');